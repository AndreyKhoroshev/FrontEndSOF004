...
export default function CustomerList() {
  ...
  // Tila dialogin avaamiseen ja muokattavan asiakkaan tallentamiseen
  const [dialogOpen, setDialogOpen] = useState<boolean>(false)
  const [editCustomer, setEditCustomer] = useState<Customer | null>(null)
  // Tila harjoitusdialogille
  ...
  // Poistetaan asiakas vahvistuksen jälkeen
  ...
  // Tallennetaan uusi tai muokattu asiakas
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', height: '100%' }}>
          ...
          <button
            ...
            style={{
              ...
              color: '#ff8000',
              border: '1px solid rgba(235, 208, 30, 0.82)',
              borderRadius: '4px',
              padding: '3px 10px',
              cursor: 'pointer',
          ...
          {/* Lisää harjoitus -painike */}
          <button
            onClick={() => { setTrainingCustomer(params.data); setTrainingDialogOpen(true) }}
            style={{
              background: 'rgb(3, 58, 31)',
              color: '#3eb842',
              border: '1px solid rgba(90,255,204,0.3)',
              borderRadius: '4px',
              padding: '3px 10px',
              cursor: 'pointer',
              fontFamily: 'monospace',
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 60px)', padding: '1.5rem 2rem', gap: '1rem' }}>
      ...
      {/* Asiakkaan lisäys/muokkaus -dialogi */}
      <CustomerDialog
        open={dialogOpen}
